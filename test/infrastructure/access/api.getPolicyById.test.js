...
const { getPolicyById } = require("../../../src/infrastructure/access/api");
...
describe("when calling the getPolicyById function", () => {
  beforeEach(() => {
    fetchApi.mockReset();
  ...
  it("then it should call policies resource with policy id", async () => {
    await getPolicyById(serviceId, policyId, correlationId);
  ...
  it("should return undefined on a 404 response", async () => {
    ...
    const result = await getPolicyById(serviceId, policyId, correlationId);
